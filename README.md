...
> **Mody serwera działają na Windowsie, macOS i Linuksie.** Nie „da się jakoś skonfigurować",
...
> **The server's mods work on Windows, macOS and Linux.** Not "can be made to work" —
> the player downloads the build for their system, clicks once, and the game has mods.
